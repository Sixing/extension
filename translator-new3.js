(function() {
    ...
    */
    ...
    function Ml(a, b, c) { Nl(a, "/gen204?" + (a.j ? ["client=", a.j, "&"].join("") : "") + Ll(a, b, c)) }
    ...
    w.ma = function() { this.H = !1; var a = te.test(vn) ? Nb : "ltr";
        this.Tb(Fh(Jr, { Ri: "https://www.gstatic.com/images/branding/product/1x/translate_24dp.png", ek: sb, gk: Gn, dir: a }));
    ...
    w.U = function() {
        ...
        Yn(this.A, A(function() {
            ...
            var Re = W.cd,
                ...
                Vu = W.zf,
                Wu = W.zf;
            ib = ig(ia + H(zg(b)) + '"></head><body class="goog-te-banner" scroll="no" border=0 dir="' + H(a) + '"><table border=0 cellspacing=0 cellpadding=0 width=100% height=100%><tr valign=middle><td width=1 nowrap><a href="' + H(sg(rb)) + '" class="goog-logo-link" target="_blank"><img src="' + H(xg("https://www.gstatic.com/images/branding/googlelogo/1x/googlelogo_color_68x28dp.png")) +
